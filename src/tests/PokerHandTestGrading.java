...
public class PokerHandTestGrading {
  ...
  public void testThreeOfKind2( ) {
    ...
    //assertEquals(4, a.getThreeOfAKindRank());
    //assertEquals(4, b.getThreeOfAKindRank());
    //assertTrue(a.compareRemainingCards(b) < 0);
    //assertTrue(b.compareRemainingCards(a) > 0);
    assertTrue(a.compareTo(b) < 0);
    assertTrue(b.compareTo(a) > 0);
 }
  ...
  public void testThreeOfAKind() {
    ...
    //assertTrue(a.hasThreeOfAKind());
    //assertTrue(b.hasThreeOfAKind());
    //assertEquals(14, a.getThreeOfAKindRank());
    //assertEquals(14, b.getThreeOfAKindRank());
    //assertEquals(1, a.compareRemainingCards(b));
    //assertEquals(-1, b.compareRemainingCards(a));
    assertTrue(a.compareTo(b) > 0);
    assertTrue(b.compareTo(a) <  0);
  }
  ...
  public void testTwoPair2() {
    ...
    //assertEquals(4, a.getFirstPairRank());
    //assertEquals(14, a.getSecondPairRank());
    //assertEquals(12, b.getFirstPairRank());
    //assertEquals(13, b.getSecondPairRank());
    //assertEquals(1, a.compareRemainingCards(b));
    assertTrue(a.compareTo(b) > 0);
  }
  ...
  public void testFullHouse6() {
    ...
    //assertEquals(2, fullHouseLow.getThreeOfAKindRank());
    //assertEquals(3, fullHouseLow.getFullHousePairRank());
    //assertEquals(14, fullHouseHigh.getThreeOfAKindRank());
    //assertEquals(13, fullHouseHigh.getFullHousePairRank());
  ...
  /*
  @Test
  public void testVarietyHands() {
	  assertTrue(fullHouse2.isFullHouse());
	  assertTrue(threeKind3.hasThreeOfAKind());
	  assertTrue(threeKind2.hasThreeOfAKind());
  }
  */
  ...
  public void testManyRanks44() {
    ...
    //assertTrue(fullHouse2.isFullHouse());
    //assertTrue(threeKindHigh.hasThreeOfAKind());
  }
}
